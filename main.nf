...
process unpackDatabase {
    ...
    cp -L --remove-destination $kmer_distribution database_dir/.
    """
}
...
process unpackTaxonomy {
    ...
    then
        cp -rL $taxonomy taxonomy_dir/${taxonomy}
    else
...
process combineFilterFastq {
    ...
    fastcat \
        ...
        -s ${sample_id} \
        -r ${sample_id}.stats \
        -x ${directory}_cpy > ${sample_id}.fastq
